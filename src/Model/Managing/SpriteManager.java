...
public class SpriteManager {
    ...
    public static final int ENTITY_FIRE_ZOMBIE = 2;
    ...
    public static final BufferedImage[][] SPRITES = new BufferedImage[][]{
        ...
        {readImageSave(Paths.get("Images/Entity/player_spritesheet.png")), readImageSave(Paths.get("Images/Entity/zombie_spritesheet.png")), readImageSave(Paths.get("Images/Entity/fire_zombie_spritesheet.png"))},
