    ...
    public LevelSelect(ProjectUnknownProperties properties){
        ...
        for (int i = 0; i < btnPlanets.length; i++) {
            ...
            btnPlanets[i].addEventHandler(IEventInteractableObject.EventType.MOUSE_RELEASED, (event) -> {
                ...
                World level = new World(Paths.get("Worlds/test.world"), new Player(ProjectUnknownProperties.getScreenDimension().width/2, ProjectUnknownProperties.getScreenDimension().height/2,properties),properties);
